# Generated by Powerlevel10k configuration wizard on 2026-08-25 at 21:43 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    llm_tasks               # incomplete tasks from .llm/todo.md
  ...
  function prompt_llm_tasks() {
    local todo_file git_root
    git_root=$(git rev-parse --show-toplevel 2>/dev/null)
    if [[ -n $git_root && -f $git_root/.llm/todo.md ]]; then
      todo_file=$git_root/.llm/todo.md
    elif [[ -f .llm/todo.md ]]; then
    ...
    (( count > 0 )) || return
    p10k segment -t "${count} tasks"
  }
  typeset -g POWERLEVEL9K_LLM_TASKS_FOREGROUND=110
